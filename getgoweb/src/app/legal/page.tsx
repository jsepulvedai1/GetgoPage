        ...
        <div className="space-y-10 text-justify text-gray-700">
          <div>
            ...
            <ul className="list-disc list-inside mb-4">
              ...
              <li>
                <strong>Datos de ubicación (Location):</strong> Recopilamos
                datos de geolocalización precisa del dispositivo para permitir
                el trazado de rutas, el cálculo automático de peajes (TAG) y la
                gestión de trayectos de transporte. Estos datos se recolectan
                incluso cuando la aplicación está en segundo plano (background)
                o no está en uso, siempre que el usuario haya iniciado un
                servicio de transporte, para asegurar la precisión en el cobro
                de pórticos y la seguridad del trayecto.
              </li>
              <li>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#000080] italic mb-2 tracking-tight">
              5. DEL ESTÁNDAR DE LOS SERVICIOS
            </h2>
            <p>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#000080] italic mb-2 tracking-tight">
              16. TRATAMIENTO DE DATOS DE UBICACIÓN (LOCATION)
            </h2>
          </div>
          <div>
            <p>
